...
public class ScientCalcuController implements Initializable {
	...
	@FXML Button btnPlus, btnMinus, btnx, btnDivide, btnSin, btnCos, btnTan, btnRoot, btnSq;
	@FXML Label result;
	Parent root;
	Stage stage;
	Scene scene;
	...
	public void initialize(URL location, ResourceBundle resource) {
		...
		btnSin.setOnAction(event->clickBtnSin(event));
		btnCos.setOnAction(event->clickBtnCos(event));
		btnTan.setOnAction(event->clickBtnTan(event));
		btnSq.setOnAction(event->clickBtnSq(event));
		btnRoot.setOnAction(event->clickBtnRoot(event));
	...
	public void switchToScient(ActionEvent event) throws IOException {
		root = FXMLLoader.load(getClass().getResource("calcu.fxml"));
	...
	void clickBtnSin(ActionEvent e) {String inputVar = btnSin.getText(); if(!outputVal.equals("")&&!(outputVal==null)) operDuplicationCheck(inputVar);}
	void clickBtnCos(ActionEvent e) {String inputVar = btnCos.getText(); if(!outputVal.equals("")&&!(outputVal==null)) operDuplicationCheck(inputVar);}
	void clickBtnTan(ActionEvent e) {String inputVar = btnTan.getText(); if(!outputVal.equals("")&&!(outputVal==null)) operDuplicationCheck(inputVar);}
	void clickBtnRoot(ActionEvent e) {String inputVar = btnRoot.getText(); if(!outputVal.equals("")&&!(outputVal==null)) operDuplicationCheck(inputVar);}
	void clickBtnSq(ActionEvent e) {String inputVar = btnSq.getText(); if(!outputVal.equals("")&&!(outputVal==null)) operDuplicationCheck(inputVar);}
	//입력값 저장
